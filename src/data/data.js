const data = {
    allQuestions: [{
        title: "Germany",
        flag: "https://res.cloudinary.com/andrerichards/image/upload/v1514879599/quiz/germFlag.png",
        pic: "https://res.cloudinary.com/andrerichards/image/upload/v1514879618/quiz/germany.png",
        rightAnswers: ["The city of Frankfurt am Main the highest per capita number of millionaires than any other city worldwide. Second on the list, is the city of Munich.",
            "Germany has had a total of five capital cities: Aachen, Regensburg, Frankfurt am Main, Nuremberg, and now Berlin. Six if you count West Germany's Bonn."
        ],
        choices: [
            "The city of Frankfurt am Main the highest per capita number of millionaires than any other city worldwide. Second on the list, is the city of Munich.",
            "Germany has had a total of five capital cities: Aachen, Regensburg, Frankfurt am Main, Nuremberg, and now Berlin. Six if you count West Germany's Bonn.",
            "Basing the modern car design concept upon Henry Ford's Model-T helped make auto manufacturers such as BMW one of the best-selling luxury vehicle brands.",
            "Munich's Oktoberfest is the largest Volksfest in the world with over 6 million annual visitors. Its name derives from the month in which the festivities begin - October."
        ],
        addlInfo: ["The modern car was based upon, the Motorwagen, originating in the city of Mannheim by Karl Benz in 1885.",
            "Despite the name, the Oktoberfest starts at the end of September, lasting until the first weekend in October."
        ]
    },
    {
        title: "Madagascar",
        flag: "https://res.cloudinary.com/andrerichards/image/upload/v1514879599/quiz/madaFlag.png",
        pic: "https://res.cloudinary.com/andrerichards/image/upload/v1514879618/quiz/madagascar.png",
        rightAnswers: ["90% of Madagascar's wild- and plantlife can ONLY be found here, including endangered lemur subspecies. The Madagascar periwinkle is a key ingredient in cancer treatment.",
            "After its introduction by French colonists in 1819, the majority of the world's vanilla strain can now be traced here to a strain known as \"Bourbon vanilla\"."
        ],
        choices: ["90% of Madagascar's wild- and plantlife can ONLY be found here, including endangered lemur subspecies. The Madagascar periwinkle is a key ingredient in cancer treatment.",
            "After its introduction by French colonists in 1819, the majority of the world's vanilla strain can now be traced here to a strain known as \"Bourbon vanilla\".",
    ...
    },
    {
        ...
        flag: "https://res.cloudinary.com/andrerichards/image/upload/v1514879599/quiz/trinFlag.png",
        pic: "https://res.cloudinary.com/andrerichards/image/upload/v1514879618/quiz/trinidad.png",
        rightAnswers: ["Despite the two islands proximity, Tobago is governed autonomously and boasts a more traditional and African-rooted atmosphere than its larger counterpart.",
        ...
        choices: ["Despite the two islands proximity, Tobago is governed autonomously and boasts a more traditional and African-rooted atmosphere than its larger counterpart.",
            "The Miss Universe Pageant has crowned two Trinidadian beauties - Miss Wendy Fitzwilliam in 1998 and the pageant's first ever black recipient in 1977 - Miss Janelle Commissiong.",
    ...
    {
        title: "China",
        flag: "https://res.cloudinary.com/andrerichards/image/upload/v1514879599/quiz/chinFlag.png",
        pic: "https://res.cloudinary.com/andrerichards/image/upload/v1514879618/quiz/china.png",
        rightAnswers: ["Tea and silk, were both accidentally discovered here after the fortuitous falling of a tea leaf and silk cocoon into an emperor and emperess's hot water cup respectively.",
    ...
    {
        title: "Fiji",
        flag: "https://res.cloudinary.com/andrerichards/image/upload/v1514879599/quiz/fijiFlag.png",
        pic: "https://res.cloudinary.com/andrerichards/image/upload/v1514879618/quiz/fiji.png",
        rightAnswers: ["The top of the head is considered sacred here. So unless you are a chief, you should leave your hats and sunglasses home. A 16th century missionary was eaten for this big taboo.",
